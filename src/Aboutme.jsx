    ...
    <div id="about" data-aos="fade-up-right" data-aos-duration="3000" style={{paddingBottom:"60px"}}>
      ...
      <Flex width="90%" margin="auto" marginTop="20px">
        ...
        <Box width="40%" margin="auto" fontSize="18px" fontWeight={"500"}>
          <Text>
          Hello! My name is Kuldeep Singh & I enjoy creating things that live on the internet. I'm a passionate Developer, with strong administrative & communication skills, good attention to detail & the ability to write efficient code.
          </Text>
