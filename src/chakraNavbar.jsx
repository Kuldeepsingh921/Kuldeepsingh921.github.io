        ...
        <Flex
          ...
          <Flex  flex={{ base: 1 }} justify={{ base: 'left', md: 'space-between', }}>
            <Text
              ...
              <Link href="/"><Image className={styles.logo} data-aos="fade-right" height={{base:"30px",md:"35px",lg:"50px"}} width={{base:"30px",md:"35px",lg:"50px"}} src={colorMode==="light"? "https://i.postimg.cc/NjfzqG8j/s-removebg-preview.png":"https://i.postimg.cc/m2v0ZRRX/s-1-removebg-preview.png"}/></Link>
            </Text>
