import { Flex,Text ,useColorMode,IconButton,Heading,FormControl,Input,FormLabel, Link,Textarea,Button} from "@chakra-ui/react"
    ...
    <Flex data-aos="fade-up-right" data-aos-duration="3000" id="contact" boxShadow= "0px 1px 5px 1px gray" flexDirection="column"mt={"10px"} gap={{base:"10",lg:""}} >
      ...
      <Flex justifyContent={"center"} align="center" flexDirection={{base:"column",lg:"row"}} gap="10" height="" >
            ...
            <Flex gap="5" flexDirection={"column"} justifyContent="center">
                    ...
                    {/* Whatsapp */}
                    <Flex align="center">
                    <Link href="https://wa.me/+917838254390?text=I%27m%20interested%20in%20your%20profile">
                    <IconButton aria-label="email"
                      ...
                      {/* Mail */}
                      <Flex align="center" >
                      <Link href="mailto:kuldeepsingh211199@gmail.com">
                      <IconButton aria-label="email"
                        variant="ghost"size="lg"
                          fontSize="3xl"
                          icon={<MdEmail />}
                          ...
                          isRound
                        /></Link>
                        <Link href="mailto:kuldeepsingh211199@gmail.com">kuldeepsingh211199@gmail.com</Link>
                      </Flex>

                      {/* github */}
                      <Flex align="center">
                      <Link href="https://github.com/Kuldeepsingh921">
                      <IconButton aria-label="email"
                        variant="ghost"size="lg"
                          fontSize="3xl"
                          icon={<BsGithub />}
                        ...
                        <Link href="https://github.com/Kuldeepsingh921">Kuldeepsingh921</Link>
                      </Flex>
                      ...
                      <IconButton aria-label="email"
                        variant="ghost"size="lg"
                          ...
                          isRound
                        /></Link>
                        <Link href="https://www.linkedin.com/in/kuldeep-singh-a50672196/">linkedin/KuldeepSingh</Link>
                      </Flex>

                      {/* Instagram */}
                      <Flex align="center">
                      <Link href="https://www.instagram.com/kuldeep5452singh/">
                      <IconButton aria-label="email"
                        variant="ghost"size="lg"
                          fontSize="3xl"
                          icon={<BsInstagram />}
                        ...
                        <Link href="https://www.instagram.com/kuldeep5452singh/">kuldeep5452singh</Link>
                      </Flex>
