...
import Kuldeep_Singh_Resume from "./Kuldeep_Singh_Resume.pdf"
...
const Homepage = () => {
  ...
  const handleClick=()=>{
    window.open(Kuldeep_Singh_Resume)
  }
  return (
    <div  data-aos="fade-up-right" data-aos-duration="3000" style={{marginTop:"50px"}}>
      ...
      <Box width="50%" margin="auto" data-aos="fade-right">
        <Text style={{fontSize:"25px",fontWeight:'Bold'}}>Hey, I'm Kuldeep Singh</Text>
...
<Link target="_blank" href="https://github.com/Kuldeepsingh921"><Box>
  ...
  <a href={Kuldeep_Singh_Resume} download="Kuldeep_Singh_Resume.pdf">
  ...
  {colorMode === 'light'?<Button  backgroundColor={"#e53e3e"} color="white" padding="20px" fontSize={"20px"} display="flex" alignItems="center"  _hover={{transform:"scale(1.1)",transition:"0.5s"}}>Resume   <MdDownload  /></Button>:<Button backgroundColor={"#6d28d9"} color="white" padding="20px" fontSize={"20px"} display="flex" alignItems="center" _hover={{transform:"scale(1.1)",transition:"0.5s"}}>Resume <MdDownload /></Button>}
        ...
        <Box width="30%" margin="auto">
          <Image className={styles.avatar} _hover={{ boxShadow:"1px 1px 50px 1px #814930"}} src="https://i.postimg.cc/X75b2GJn/resume1-transformed-1.png" borderRadius={"40%"} width="300px"></Image>
        </Box>
     </Flex>
      </div>:
      // Mobile view
      ...
      <Center><Box>
      <Image src="https://i.postimg.cc/X75b2GJn/resume1-transformed-1.png" borderRadius={"50%"} width="200px"></Image>
     </Box>
     </Center>
     <Box marginTop="20px">
...
<a onClick={handleClick} href={Kuldeep_Singh_Resume}  download="Kuldeep_Singh_Resume.pdf">
<Box >
