  ...
  return (
    <div id="about" data-aos="fade-up-right" data-aos-duration="3000">
      ...
      <Flex width="90%" margin="auto" marginTop="20px">
        <Box width="50%">
            <Image src="https://www.lambdatest.com/resources/images/news24.gif" width="80%"></Image>
        </Box>
        <Box width="40%" margin="auto" fontSize="18px" fontWeight={"500"}>
          <Text>
          Hello! My name is Kuldeep Singh. I'm a growth-oriented Full-Stack Web Developer with strong adaptive,administrative & communication skills, good attention to detail & the ability to write efficient code.
          </Text>
      ...
      <Text>
      Hello! My name is Kuldeep Singh. I'm a growth-oriented Full-Stack Web Developer with strong adaptive,administrative & communication skills, good attention to detail & the ability to write efficient code.      </Text>
      <hr style={{marginTop:"20px"}}/>
      <Text marginTop="10px">I'm open to Job opportunities. If you think my skills are relevant to your job requirements then do <Link color="red" href="/#contact">contact</Link> me.</Text>
    </Box>
    <Box  marginTop="60px">
        <Image src="https://www.lambdatest.com/resources/images/news24.gif" width="100%"></Image>
    </Box>
    </Box>}
